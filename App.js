...
import AssignmentIcon from './src/assets/images/outline_assignment_black_24dp.png';
  ...
  return (
    <DrawerContentScrollView {...props}>
      <Text
        ...
        Hello, {state.userToken.fullName.split(' ')[0]}
      </Text>
      ...
      <DrawerItem
        ...
        icon={({ focused }) => (
          <Image
            source={LogoutIcon}
            style={{ tintColor: focused ? 'orange' : 'black' }}
          />
        )}
      />
    </DrawerContentScrollView>
